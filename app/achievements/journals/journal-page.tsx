...
import { JournalPublication, PublicationType } from "@/types";
...
// 年度ごとにグループ化する関数
function groupByYear(papers: JournalPublication[]): {
  [key: string]: JournalPublication[];
} {
  return papers.reduce(
    ...
    {} as { [key: string]: JournalPublication[] },
  );
}
    ...
    <div>
        ...
        <div className="container relative z-10">
          <div className="text-center">
            <h1 className="text-2xl md:text-3xl text-white font-bold mb-4">
              {t.title.journalPapers}
            </h1>
            <p className="text-xl text-gray-300">{t.subtitle.journalPapers}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container">
          <AchievementTagList
            activeTag={PublicationType.journal}
            language={language}
          />
          <YearFilter
            allYears={years}
